            ...
            <div class="card-body">
                ...
                <form id="employeeForm" method="POST" action="{{ route('employees.update', $employee->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nik" value="{{ $employee->nik }}" required>
                                </div>
                                <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        ...
                        <textarea class="form-control" name="address" rows="2" required>{{ $employee->address }}</textarea>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" name="salary" min="0" value="{{ $employee->salary }}" required>
                        </div>
                    </div>
